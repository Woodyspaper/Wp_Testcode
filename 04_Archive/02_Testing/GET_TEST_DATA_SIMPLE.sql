-- Simple test data query - Get GRP_COD directly from pricing rules
-- Date: December 30, 2025
-- The fn_GetContractPrice function uses NCR_BID_NO = GRP_COD from IM_PRC_RUL table

-- Option 1: Get contract group codes (use these as NCR_BID_NO in API test)
...
-- Option 3: Test with a specific contract group
...
WHERE r.GRP_TYP = 'C'
  AND r.GRP_COD = 'YOUR_GRP_COD'  -- Replace with actual GRP_COD
